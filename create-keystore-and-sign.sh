...
/home/c4pt000/Android/Sdk/build-tools/34.0.0/apksigner sign --ks my-release-key.jks --out Bitnet-4.2.7.0-arm64-v8a-signed.apk Bitnet-4.2.7.0-arm64-v8a-debug.apk
 rm -rf my-release-key.jks

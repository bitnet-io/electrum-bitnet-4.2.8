...
If this is enabled, other nodes cannot open a channel to you. Channel recovery data is encrypted, so that only your wallet can decrypt it. However, blockchain analysis will be able to tell that the transaction was probably created by Electrum-BIT.
"""
...
It may be imported in another Electrum-BIT wallet with the same seed.
"""

MSG_LIGHTNING_EXPERIMENTAL_WARNING = """
Lightning support in Electrum-BIT is experimental. Do not put large amounts in lightning channels.
"""

MSG_LIGHTNING_SCB_WARNING = """
Electrum-BIT uses static channel backups. If you lose your wallet file, you will need to request your channel to be force-closed by the remote peer in order to recover your funds. This assumes that the remote peer is reachable, and has not lost its own data.
"""

...
class BitnetIOAverage(ExchangeBase):
...
class BitnetIOtoyou(ExchangeBase):
...
class BitnetIOVenezuela(ExchangeBase):
...
class LocalBitnetIOs(ExchangeBase):
...
class MercadoBitnetIO(ExchangeBase):
